export const projects = [
  ...
  },
  {
    title: "Unixpense",
    description:
      "A user-friendly expense tracker application that allows users to manage expenses, perform actions like creation, deletion, saving, loading, and in-depth analysis. The project includes an end-to-end object-oriented program (OOP) in Java, seamless data read/write using JSON, and an intuitive graphical user interface (GUI) designed with Java Swing.",
    image: "/images/1.png",
    tags: ["Java", "JSON"],
  ...
  },
  {
    ...
    description:
      "A Chrome extension that sends periodic alerts to users every 20 minutes, with an option to opt out of reminders while the timer is active. User data collected by the extension is transmitted to a dashboard, allowing users to access and analyze their weekly statistics. Developed using HTML, CSS, and JavaScript.",
    image: "/images/0.png",
